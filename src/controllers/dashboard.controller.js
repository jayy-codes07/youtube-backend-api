...
const getChannelStats = asyncHandler(async (req, res) => {
  ...
  const channelstates = [subscribers, video]

  return res.status(200).json(new ApiResponse(200, channelstates, "channel states like total views, subscribers, video, likes"))
